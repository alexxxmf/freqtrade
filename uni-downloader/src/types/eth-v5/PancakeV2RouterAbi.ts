...
export interface PancakeV2RouterAbiInterface extends utils.Interface {
  functions: {
...
export interface PancakeV2RouterAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PancakeV2RouterAbiInterface;
