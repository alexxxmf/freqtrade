...
export interface PancakeLpContractAbiInterface extends utils.Interface {
  functions: {
...
export interface PancakeLpContractAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PancakeLpContractAbiInterface;
