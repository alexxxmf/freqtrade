...
export interface PancakeV2FactoryAbiInterface extends utils.Interface {
  functions: {
...
export interface PancakeV2FactoryAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PancakeV2FactoryAbiInterface;
